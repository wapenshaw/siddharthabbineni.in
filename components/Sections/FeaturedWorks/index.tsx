...
const MotionGrid = motion.create(Grid) as React.ComponentType<GridProps & MotionProps>
const MotionGridItem = motion.create(GridItem) as React.ComponentType<GridItemProps & MotionProps>
